...
def build_app() -> gr.Blocks:
    with gr.Blocks(
        ...
        config_state, config_inputs, cfg_data_path, cfg_save_dir = build_config_tab()
        build_train_tab(config_state, cfg_data_path, cfg_save_dir)
        build_inference_tab(config_state)
        build_benchmark_tab()
        build_autotune_tab(config_state)
