...
def build_train_tab(config_state: gr.State, cfg_data_path: gr.Textbox, cfg_save_dir: gr.Textbox):
    with gr.Tab(t("tab.train")) as tab:
        register_translatable(tab, "tab.train")

        # ── Dataset drag-drop shortcut (writes to Config tab's data_path) ─
        ...
        def start_training(cfg, train_mode):
